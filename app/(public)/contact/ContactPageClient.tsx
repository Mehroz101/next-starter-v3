            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
                <div className="h-80 w-full relative">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100940.14245968236!2d-122.43759999999999!3d37.75769999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan%20Francisco%2C%20CA%2C%20USA!5e0!3m2!1sen!2s!4v1661239343703!5m2!1sen!2s"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md">
              ...
              <p className="text-gray-600">
                Yes, we specialize in custom solutions tailored to your specific business needs. Contact us to discuss your requirements.
              </p>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-md">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">What are your support hours?</h3>
              <p className="text-gray-600">
                Our support team is available Monday through Friday from 9AM to 5PM PST. We also offer emergency support for critical issues.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md">
              ...
              <p className="text-gray-600">
                Absolutely! We&apos;d be happy to give you a personalized demo of our services. Use the contact form to request a demo session.
              </p>
            </div>
          </div>
        </div>
