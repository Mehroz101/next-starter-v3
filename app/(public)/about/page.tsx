  ...
  const teamMembers = [
    {
      ...
      bio: "10+ years of experience in product development and leadership."
    },
    {
      name: "Michael Chen",
      role: "Lead Developer",
    ...
    },
    {
      ...
      bio: "Expert in growth strategies and digital marketing campaigns."
    }
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p>
                  Today, our team spans across multiple countries, united by a common goal of building software that makes a positive impact.
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-600">
                We constantly explore new ideas and technologies to improve our products.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl text-center">
              ...
              <p className="text-gray-600">
                We believe in building strong relationships with our users and partners.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="bg-white text-blue-600 hover:bg-blue-50 font-semibold py-3 px-8 rounded-xl transition-colors duration-300 shadow-lg hover:shadow-xl"
            >
              Create Account
            </Link>
            <Link
              href="/contact"
              className="border-2 border-white text-white hover:bg-white/10 font-semibold py-3 px-8 rounded-xl transition-all duration-300"
            >
              Contact Sales
            </Link>
          </div>
