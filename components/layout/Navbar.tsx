...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="w-full flex justify-center px-4 sm:px-6 lg:px-8 fixed top-4 z-50">
      <div className="w-full max-w-6xl bg-white/95 backdrop-blur-sm border border-gray-200 rounded-[50px] max-sm:rounded-xl px-6 py-4 lg:px-8 lg:py-5 shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200">
            <div className="flex flex-col gap-3">
              <MobileNavLink href="/spend" >Spend</MobileNavLink>
              <MobileNavLink href="/save" >Save</MobileNavLink>
              <MobileNavLink href="/invest" >Invest</MobileNavLink>
